...
# my facebook ( https://www.facebook.com/Aleena.tricker )
...
def moch_yayan():
    ...
    print(f"Author   :    Aleena Khan ")

    print(f"Versi SC   :   V1.0")

    print("===============================================")

    print(f"Nama FB     :    {Aleena}")

    print(f"ID FB    :   {https://www.facebook.com/Aleena.tricker}")

    print("===============================================")

    print(f" MENU ")

    print(' [%s02%s]. Crack Public ID'%(O,N));time.sleep(0.03)

    print(' [%s03%s]. Crack Followers ID'%(O,N));time.sleep(0.03)

    print(' [%s04%s]. Crack ID dari Like Postingan'%(O,N));time.sleep(0.03)

    print(' [%s00%s]. Logout (%Cookie%s)'%(M,N,M,N));time.sleep(0.03)
...
class __crack__:
    ...
    def __pler__(self):
        ...
        if yan == '':
            ...
            print('\n [%s+%s] Aleena OK -> results/OK-%s-%s-%s.txt'%(O,N,ha, op, ta))

            print(' [%s+%s] Aleena CP -> results/CP-%s-%s-%s.txt'%(O,N,ha, op, ta))
...
def proses():
    ...
    print('\n\n %s[%s+%s] Aleena OK  -> results/IG-OK-%s-%s-%s.txt'%(N,O,N,ha, op, ta));time.sleep(0.2)

    print(' [%s+%s] Aleena CP  -> results/IG-CP-%s-%s-%s.txt'%(O,N,ha, op, ta));time.sleep(0.2)

    print('\n [%s!%s] ctrl+z to stop the process\n'%(M,N));time.sleep(0.2)
